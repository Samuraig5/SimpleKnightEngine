...
public class SolarSystemScene extends Scene
{
    public SolarSystemScene(SimpleKnightEngine engine) {
        ...
        SolarObject sun = new SolarObject(this, sunIcon, FreeVector.create(100,100,0));
        addGameObject(sun);
        ...
        SolarObject planet1 = new SolarObject(this, planetIcon, FreeVector.create(1000,1000,0));
        planet1.setParent(sun, 600, 0.01);
        addGameObject(planet1);

        SolarObject planet2 = new SolarObject(this, planetIcon, FreeVector.create(1000,1000,0));
